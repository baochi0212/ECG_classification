...
def parse_args():
    ...
    parser.add_argument('--data-dir', type=str, default='formatted/thnig/formatted_files.json', help='Directory for data dir')
...
if __name__ == "__main__":
    ...
    train_dataset = ECG_Dataset('train','formatted/thnig/formatted_files.json', 'all', 'data/training/Training_WFDB', train_folds)
    train_loader = DataLoader(train_dataset, batch_size=args.batch_size, shuffle=True, num_workers=args.num_workers, pin_memory=True)
    val_dataset = ECG_Dataset('train','formatted/thnig/formatted_files.json', 'all', 'data/training/Training_WFDB', val_folds)
    val_loader = DataLoader(val_dataset, batch_size=args.batch_size, shuffle=False, num_workers=args.num_workers, pin_memory=True)
    test_dataset = ECG_Dataset('train','formatted/thnig/formatted_files.json', 'all', 'data/training/Training_WFDB', test_folds)
